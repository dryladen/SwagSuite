...
export const DEFAULT_STAGES: ProductionStage[] = [
  ...
  { id: 'order-placed', name: 'Order Placed', order: 6, color: 'bg-teal-100 text-teal-800', icon: 'Package', description: 'Production order placed' },
  { id: 'invoice-paid', name: 'Invoice Paid', order: 7, color: 'bg-green-100 text-green-800', icon: 'CreditCard', description: 'Payment received' },
  { id: 'shipping-scheduled', name: 'Shipping Scheduled', order: 8, color: 'bg-cyan-100 text-cyan-800', icon: 'Truck', description: 'Shipment scheduled' },
  { id: 'shipped', name: 'Shipped', order: 9, color: 'bg-emerald-100 text-emerald-800', icon: 'MapPin', description: 'Order shipped to customer' },
];
